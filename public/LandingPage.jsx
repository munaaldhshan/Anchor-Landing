...
import { Anchor, Nfc, Timer, Target, Ban, BarChart3, Sparkles, Trophy, TriangleAlert, Lightbulb, Check } from 'lucide-react';
  ...
  style.textContent = `
    * {
    ...
    .hero-showcase {
      ...
      max-width: 640px;
      height: 440px;
      margin: ${spacing.xl}px auto ${spacing.xxxl * 1.5}px;
    }

    .hero-showcase .comp-cube {
      position: absolute;
      top: 6%;
      right: 14%;
      width: 34%;
      max-width: 180px;
      z-index: 1;
      filter: drop-shadow(0 16px 28px rgba(49, 56, 82, 0.25));
    }

    .hero-showcase .comp-phone {
      position: absolute;
      top: 50%;
      left: 50%;
      width: 52%;
      ...
      filter: drop-shadow(0 24px 40px rgba(49, 56, 82, 0.3));
      transition: transform 0.4s ease;
    }

    .hero-showcase:hover .comp-phone {
      transform: translate(-50%, -50%) rotate(15deg);
    }

    .hero-showcase .comp-notification {
      position: absolute;
      bottom: 10%;
      left: 6%;
      width: 46%;
      ...
      border-radius: ${radii.lg}px;
      filter: drop-shadow(0 12px 24px rgba(49, 56, 82, 0.25));
      transition: transform 0.4s ease;
    }

    .hero-showcase:hover .comp-notification {
    ...
    @media (max-width: 1024px) {
      ...
      .hero-showcase .comp-cube { right: 10%; width: 32%; }
      .hero-showcase .comp-notification { left: 4%; width: 44%; }
    }
    ...
    @media (max-width: 768px) {
      ...
      .hero-showcase .comp-cube { top: 4%; right: 6%; width: 30%; }
      .hero-showcase .comp-phone { width: 48%; }
      .hero-showcase .comp-notification { bottom: 6%; left: 2%; width: 42%; }
    }
    ...
    @media (max-width: 480px) {
      ...
      .hero-showcase .comp-cube { top: 2%; right: 4%; width: 28%; }
      .hero-showcase .comp-phone { width: 50%; }
      .hero-showcase .comp-notification {
        bottom: 0;
        left: 50%;
        width: 60%;
    ...
    <section className="hero">
      <div className="container">
        ...
        <div className="hero-showcase">
          <img className="comp-cube" src="visuals/cube.png" alt="" aria-hidden="true" />
          <img className="comp-phone" src="visuals/mockup1.png" alt="Anchor app running on a phone, secured by an NFC tag" />
          <img className="comp-notification" src="visuals/Notification%20(1).png" alt="Session complete notification: Great work, tap to see your results" />
        </div>
        ...
        <div className="grid grid-3">
          {features.map((f, i) => (
            <div key={i} className="card feature-card animate-in" style={{ animationDelay: `${i * 0.1}s` }}>
              <div className="feature-icon"><f.icon size={40} /></div>
              <h3>{f.title}</h3>
              <p>{f.description}</p>
            </div>
          ))}
    ...
    },
    {
      ...
      content: (
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ marginTop: spacing.xl, fontSize: fontSize.sm, color: colors.mutedLight, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: spacing.xs }}>
            <Ban size={14} /> Instagram blocked
          </div>
        </div>
      ),
    },
      ...
      content: (
        <div style={{ textAlign: 'center', padding: spacing.xl }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Nfc size={40} color={colors.ink} /></div>
          </div>
      ...
      content: (
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: fontSize.xs, color: colors.mutedLight, textAlign: 'left', marginTop: spacing.lg }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: spacing.xs }}><Check size={14} /> 45 min session</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: spacing.xs }}><Check size={14} /> No distractions</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: spacing.xs }}><Check size={14} /> NFC verified</div>
          </div>
        </div>
      ),
    },
        ...
        <div className="grid grid-2">
          <div className="card animate-in">
            <h3 className="text-xl" style={{ marginBottom: spacing.lg }}>
              <BarChart3 className="icon-heading" /> Weekly Analytics
            </h3>
          ...
          <div className="card animate-in delay-1">
            <h3 className="text-xl" style={{ marginBottom: spacing.lg }}>
              <Sparkles className="icon-heading" /> AI-Powered Insights <span className="coming-soon">Beta</span>
            </h3>
            <p style={{ color: colors.muted, marginBottom: spacing.xl, fontSize: fontSize.sm }}>
            ...
            <div style={{
              ...
              <div style={{ marginBottom: spacing.lg }}>
                <strong><Trophy className="icon-inline" /> Best Time to Focus</strong><br />
                Tuesday 2–4 PM (92% success rate)
              </div>
              <div style={{ marginBottom: spacing.lg }}>
                <strong><TriangleAlert className="icon-inline" /> Distraction Risk</strong><br />
                High between 3–5 PM (Instagram, Discord)
              </div>
              <div>
                <strong><Lightbulb className="icon-inline" /> Suggestion</strong><br />
    ...
    <footer>
      <div className="container" style={{ maxWidth: 1200 }}>
        <div style={{ marginBottom: spacing.xxxl }}>
          <p style={{ fontSize: fontSize.xxl, fontWeight: 700, marginBottom: spacing.lg, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: spacing.xs }}><Anchor size={24} /> Anchor</p>
          <p style={{ color: colors.mutedLight, marginBottom: spacing.xl }}>
